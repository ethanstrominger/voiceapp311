...
class MyCityResponseDataModel:
    ...
    def __init__(self):
        self._session_attributes = {}  # should get from request
        self._card_title = None  # what's displayed on alexa screen
        self._output_speech = None  # what alexa says
        self._reprompt_text = None  # what alexa asks if it doesn't OPTIONAL
        self._should_end_session = None  # NONE
        self._intent_variables = {}  # OPTIONal
        self._dialog_directive = None  # see trash intent
        self._slot_to_elicit = None  # see trash intent
